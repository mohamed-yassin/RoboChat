...
if( !class_exists('NAMESPACE_acf_field_pre_made_data') ) :


class NAMESPACE_acf_field_pre_made_data extends acf_field {
	...
	*/
	...
	function __construct( $settings ) {
		...
		*  var message = acf._e('pre_made_data', 'error');
		*/
...
// initialize
new NAMESPACE_acf_field_pre_made_data( $this->settings );

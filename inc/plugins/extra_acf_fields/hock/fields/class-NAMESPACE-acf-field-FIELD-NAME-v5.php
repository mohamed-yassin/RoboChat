...
if( !class_exists('NAMESPACE_acf_field_hock') ) :


class NAMESPACE_acf_field_hock extends acf_field {
...
// initialize
new NAMESPACE_acf_field_hock( $this->settings );
